...
const DOG_BREEDS = [
  // Common (40 breeds)
  {
    ...
    personality: "The eternal optimist who believes every stranger is just a best friend they haven't met yet",
    humanJob: "Camp counselor who also volunteers at the food bank on weekends and never says no",
    coffeeOrder: "Vanilla latte with extra shots — enthusiastic energy but fundamentally sweet",
  ...
  },
  {
    ...
    personality: "The chill urban socialite with strong opinions about nap schedules and oat milk",
    humanJob: "Barista at an achingly cool coffee shop who also records a podcast about nothing in particular",
    coffeeOrder: "Oat milk flat white — effortlessly on-trend, doesn't over-explain itself",
  ...
  },
  {
    ...
    personality: "Pure sunshine in fur form — genuinely delighted by absolutely everything, every single day, forever",
    humanJob: "Elementary school teacher who also coaches soccer, organizes the bake sale, and cries at graduation",
    coffeeOrder: "Large drip coffee with way too much sugar — enthusiastic, reliable, and a little basic in the best way",
  ...
  },
  {
    ...
    personality: "The serious professional who secretly loves belly rubs but would die before admitting it at work",
    humanJob: "Police detective who also teaches a self-defense class and reads philosophy on their lunch break",
    coffeeOrder: "Black coffee, no sugar — efficient, no-nonsense, exactly what it needs to be",
  ...
  },
  {
    ...
    personality: "The effortlessly brilliant overachiever who somehow also has perfect hair and a sense of humor",
    humanJob: "Software engineer who also does competitive ballroom dancing and speaks three languages fluently",
    coffeeOrder: "A precise pour-over, ground to exactly 18.5 grams — they know the correct water temperature",
  ...
  },
  {
    ...
    personality: "The unmovable philosopher who has achieved enlightenment through the art of doing absolutely nothing",
    humanJob: "Art critic who delivers devastating verdicts in very few words and takes magnificent naps between reviews",
    coffeeOrder: "Decaf — not because they have to, but because they genuinely can't be bothered with the extra energy",
  ...
  },
  {
    ...
    personality: "The cheerful detective who gets completely distracted by every interesting smell on the way to solving the case",
    humanJob: "Food critic with an extraordinary nose who gets lost on the way to every restaurant but loves the journey",
    coffeeOrder: "Whatever smells most interesting right now — probably something seasonal and hazelnut",
  ...
  },
  {
    ...
    personality: "Big dog energy trapped in a tiny body — absolutely convinced they could take on any threat, immediately",
    humanJob: "Executive assistant who actually runs the company and everyone knows it",
    coffeeOrder: "Espresso, straight — small, strong, and takes no time wasted",
  ...
  },
  {
    ...
    personality: "Bold, stubborn, and absolutely convinced their elongated form is peak physical achievement",
    humanJob: "Investigative journalist who burrows deep into a story and refuses to come out until justice is served",
    coffeeOrder: "A very long cortado — mirrors their personal brand",
  ...
  },
  {
    ...
    personality: "A perpetual puppy who is physically incapable of greeting anyone without full-body enthusiasm",
    humanJob: "Personal trainer who also does improv comedy and genuinely loves every single client they've ever met",
    coffeeOrder: "Pre-workout mixed into a cold brew — for the extra bounce they honestly don't need",
  ...
  },
  {
    ...
    personality: "Born royalty who graciously allows commoners to provide belly rubs in exchange for their adorable presence",
    humanJob: "Lifestyle influencer whose aesthetic is flawless and who has never once carried their own bags",
    coffeeOrder: "Rose latte with oat milk — beautiful, delicate, and slightly high-maintenance",
  ...
  },
  {
    ...
    personality: "A tiny sun with a massive gravitational pull — everything and everyone revolves around them",
    humanJob: "Celebrity publicist who is technically never off the clock and has opinions on everyone's choices",
    coffeeOrder: "A very elaborate customized drink that takes three tries to say correctly — they have a system",
  ...
  },
  {
    ...
    personality: "The lovable gremlin who makes you smile by simply existing and knowing it",
    humanJob: "Stand-up comedian who never needs to say anything — their face does all the work",
    coffeeOrder: "Whipped cream on top of anything — they're here for the vibe, not the caffeine",
  ...
  },
  {
    ...
    personality: "An ancient aristocrat who has maintained their elegance and poise for 2,000 years without breaking a sweat",
    humanJob: "Luxury travel blogger who only stays at five-star properties and has an opinion on every thread count",
    coffeeOrder: "Chamomile tea — elegant, timeless, and not interested in anything too aggressive",
  ...
  },
  {
    ...
    personality: "Napoleonic energy in the smallest possible package — has never once been intimidated by anyone",
    humanJob: "CEO of a tech startup who is aggressively decisive and somehow always the most memorable person in the room",
    coffeeOrder: "A single, scalding espresso shot — small, intense, and over before you know it",
  ...
  },
  {
    ...
    personality: "Sweet, gentle, and deeply emotional — the dog that looks at you like you are literally the world",
    humanJob: "Kindergarten teacher with the most beautiful handwriting who sends home individual thank-you notes",
    coffeeOrder: "A latte with a flower art on top — they appreciate the little gestures",
  ...
  },
  {
    ...
    personality: "Boundlessly enthusiastic team player who is somehow equally great at every single thing they try",
    humanJob: "Outdoor adventure guide who also does half-marathons for fun and always brings enough snacks for everyone",
    coffeeOrder: "Double espresso in a compostable cup — they're moving too fast to think about the cup",
  ...
  },
  {
    ...
    personality: "The sharp-dressed wit who always has a clever comment and never takes themselves too seriously",
    humanJob: "Comedy writer for a late-night show who has better jokes than the host and dresses better too",
    coffeeOrder: "Americano with a splash of cream — classic, a little fancy, zero pretension",
  ...
  },
  {
    ...
    personality: "Incandescently cheerful — radiates joy the way the sun radiates warmth, and is never, ever grumpy",
    humanJob: "Greeting card writer and part-time party planner who cries happy tears at every event they coordinate",
    coffeeOrder: "Fluffy whipped coffee — it matches their aesthetic perfectly and makes everyone smile",
  ...
  },
  {
    ...
    personality: "The clever, bearded intellectual who has a strong opinion on everything and is usually right",
    humanJob: "University professor who writes blistering op-eds and is the most quotable person in every faculty meeting",
    coffeeOrder: "Drip coffee with exactly one sugar — consistent, principled, no-nonsense",
  ...
  },
  {
    ...
    personality: "Cheerfully stubborn — will agree with you in principle, then do exactly what they planned anyway",
    humanJob: "Small business owner who has been doing it their way for 20 years and it works just fine, thank you",
    coffeeOrder: "Strong Scottish breakfast tea — brisk, no-nonsense, deeply traditional",
  ...
  },
  {
    ...
    personality: "The brilliant, devoted honors student who always does the extra credit and earns it completely",
    humanJob: "Competitive agility trainer who also homeschools their kids and has already prepared tomorrow's lessons",
    coffeeOrder: "Precisely timed pour-over — they set a timer, they know the ratios, they're consistent",
  ...
  },
  {
    ...
    personality: "Scrappy, cheerful, and absolutely convinced they can handle anything — and they usually can",
    humanJob: "Freelance investigative reporter who works twice as hard as anyone and spends nothing on office space",
    coffeeOrder: "Whatever's cheapest and strongest — they're practical, not pretentious",
  ...
  },
  {
    ...
    personality: "Runs marathons for fun, has a signature look, and is somehow friends with everyone at the firehouse",
    humanJob: "Professional marathon runner who moonlights as a firefighter and has inexhaustible stamina",
    coffeeOrder: "A spotty macchiato — they appreciate when things match their aesthetic",
  ...
  },
  {
    ...
    personality: "Tiny, energetic genius who would absolutely win the game show if they were allowed to compete",
    humanJob: "World champion memory athlete who also holds a black belt and speaks six languages",
    coffeeOrder: "Espresso with a butterfly latte art — they noticed you drew it wrong but chose not to say anything",
  ...
  },
  {
    ...
    personality: "The vivacious social butterfly who makes every party better and somehow knows everybody already",
    humanJob: "Events coordinator who throws the best parties in the city and makes every guest feel like the guest of honor",
    coffeeOrder: "Cuban cortado — espresso with a splash of warm milk, vibrant and sociable",
  ...
  },
  {
    ...
    personality: "Fiercely devoted and wildly athletic — the dog equivalent of a decathlete who also cries at sunsets",
    humanJob: "Elite endurance athlete who insists on working from home specifically to be near their family",
    coffeeOrder: "Pre-run espresso that they drink while already stretching — they don't stop moving",
  ...
  },
  {
    ...
    personality: "The silver-screen-handsome overachiever who is athletic, intelligent, and somehow in every photo looking perfect",
    humanJob: "Fashion photographer who also runs ultramarathons and has a studio that doubles as a gallery",
    coffeeOrder: "Silver needle white tea — elegant, rare, and commands attention without trying",
  ...
  },
  {
    ...
    personality: "Single-mindedly focused on the task at hand — can ignore literally everything else when in work mode",
    humanJob: "Elite wildlife photographer who stands motionless for hours in freezing marshes without complaint",
    coffeeOrder: "Black coffee in a travel thermos — they have places to be and birds to find",
  ...
  },
  {
    ...
    personality: "Noblest of friends — perceptive, gentle, and the first to know when something is wrong",
    humanJob: "Crisis counselor who also volunteers with search and rescue on weekends, pure of heart and patient",
    coffeeOrder: "Warm chamomile tea with honey — comforting, dependable, good for everyone",
  ...
  },
  {
    ...
    personality: "Impossibly cheerful cattle herder who would absolutely roast you but means it with love",
    humanJob: "Project manager who herds everyone toward deadlines with cheerful, irresistible authority",
    coffeeOrder: "Earl Grey tea with milk — royal by association and not apologizing for it",
  ...
  },
  {
    ...
    personality: "The serious middle sibling who holds everything together and has never once been underestimated twice",
    humanJob: "Operations manager who has contingency plans for their contingency plans and never misses a deadline",
    coffeeOrder: "Black coffee, same order every time — dependable and efficient above all",
  ...
  },
  {
    ...
    personality: "The dignified eccentric who doesn't need your approval and would like you to know it, politely",
    humanJob: "Retired judge who writes a very popular anonymous memoir and knows far more than they ever let on",
    coffeeOrder: "Single malt whisky, neat — because they're a Scottie and they live by their own rules",
  ...
  },
  {
    ...
    personality: "A big, bumbling, lovable chaos agent who means well, gets lost in their own coat, and is somehow always joyful",
    humanJob: "Improv comedian and part-time sheepdog who has never prepared for a performance and always nails it",
    coffeeOrder: "Whatever was closest — they knocked the other one over with their tail two seconds ago",
  ...
  },
  {
    ...
    personality: "Elegant and laid-back at home, then a focused professional the moment they step outside — effortless duality",
    humanJob: "Landscape architect who is utterly relaxed at dinner parties but ferociously precise on the job site",
    coffeeOrder: "Loose-leaf tea from a beautiful tin — refined, unhurried, with an eye for the lovely things",
  ...
  },
  {
    ...
    personality: "The lovable agent of chaos who does everything at maximum intensity and has the most unique face at every party",
    humanJob: "Stuntperson and part-time mascot who throws themselves into every situation with zero hesitation",
    coffeeOrder: "Energy drink at 7am — they don't need it, they just like the intensity",
  ...
  },
  {
    ...
    personality: "Hardworking water adventurer who genuinely loves swimming, loves their family, and loves having a job to do",
    humanJob: "Marine biologist who also does competitive open-water swimming and coaches youth kayaking on weekends",
    coffeeOrder: "Cold brew in a reusable cup — practical, refreshing, goes wherever the adventure takes them",
  ...
  },
  {
    ...
    personality: "The friendly watchdog who makes everyone feel welcome and somehow always knows when you're coming home",
    humanJob: "Harbor master at a small port who knows everyone's schedule, greets every boat, and never sleeps in",
    coffeeOrder: "Warm stroopwafel on top of their coffee — Dutch tradition, purely delightful",
  ...
  },
  {
    ...
    personality: "The confident, versatile overachiever who genuinely excels at everything and somehow isn't insufferable",
    humanJob: "Military officer turned entrepreneur — brings chain-of-command efficiency to a startup nobody doubted they'd build",
    coffeeOrder: "Large dark roast, nothing added — powerful, takes no nonsense, gets results",
  ...
  },
  {
    ...
    personality: "The high-performing all-rounder who excels at everything outdoors and is exhausting in the best possible way",
    humanJob: "Triathlete who is also a wilderness guide, wildlife photographer, and consistently the most capable person in the field",
    coffeeOrder: "Double espresso before the 6am run — non-negotiable, the day has already started",
  ...
  // Uncommon (30 breeds)
  {
    ...
    personality: "The free-spirited escape artist who will absolutely blow their coat, ignore commands, and stare into your soul",
    humanJob: "Adventure photographer who has been to 60 countries, owns nothing unnecessary, and sends cryptic postcards",
    coffeeOrder: "Nothing — they just escaped through the cafe door and are already three blocks away",
  ...
  },
  {
    ...
    personality: "The stoic protector with a secretly squishy heart who headbutts you affectionately and thinks it's subtle",
    humanJob: "Personal bodyguard who also bakes elaborate cakes for every colleague's birthday",
    coffeeOrder: "Strong black coffee — reliable, no-nonsense, exactly as advertised",
  ...
  },
  {
    ...
    personality: "The razor-sharp intellect with intimidating efficiency — loyal beyond measure to those who earn their trust",
    humanJob: "Corporate attorney who wins 97% of cases and is also the most punctual person alive",
    coffeeOrder: "Precise drip coffee, 9 minutes at exactly 200°F — they timed it and they were right",
  ...
  },
  {
    ...
    personality: "The type-A overachiever who needs to be doing something at all times or will rearrange your furniture",
    humanJob: "Agility coach who also manages a sheep farm, competes in flyball, and doesn't understand the concept of rest",
    coffeeOrder: "An Australian flat white — not actually from Australia, but it fits perfectly",
  ...
  },
  {
    ...
    personality: "Infinitely gentle, endlessly loving, and somehow makes everyone around them feel calmer just by existing",
    humanJob: "Therapist with a perfect client retention rate who makes the office a room you never want to leave",
    coffeeOrder: "A small, warm vanilla tea latte — kind, comforting, and leaves you feeling better than before",
  ...
  },
  {
    ...
    personality: "Profound, reserved, and unspeakably loyal — their silence means more than most dogs' loudest declarations",
    humanJob: "Master craftsman who speaks rarely but has made only perfect things for 40 years",
    coffeeOrder: "Ceremonial matcha, whisked properly — ancient, intentional, and not changing for anyone",
  ...
  },
  {
    ...
    personality: "Ancient, powerful, and deeply playful — like a Viking who also thinks belly rubs are extremely important",
    humanJob: "Expedition mountaineer who hauls unimaginable loads and tells impossible stories in a complete deadpan",
    coffeeOrder: "Cowboy coffee boiled over a campfire — ancient, strong, and made with absolutely no equipment",
  ...
  },
  {
    ...
    personality: "The ultimate professional — runs faster, works harder, and focuses longer than anything else in any room",
    humanJob: "Special forces operator who is currently on their third certification, doesn't stop moving, and has zero patience for excuses",
    coffeeOrder: "Pre-workout and black coffee simultaneously — they've already been working for two hours",
  ...
  },
  {
    ...
    personality: "Calm, observant power — the one who doesn't need to raise their voice because they never need to",
    humanJob: "Head of security for someone very important — silent, thorough, and everyone notices when they enter a room",
    coffeeOrder: "Dark espresso, double shot, no ceremony — ancient, serious, no time for embellishments",
  ...
  },
  {
    ...
    personality: "Gentle, jowly genius who is completely unstoppable once a scent is found — wrinkles sold separately",
    humanJob: "Cold case detective who has solved cases from 40 years ago using evidence everyone else overlooked",
    coffeeOrder: "They'd rather smell it than drink it — but if pressed, something rich and dark with complicated notes",
  ...
  },
  {
    ...
    personality: "The most beautiful dog at the party who is also the most enthusiastic and probably knocked over a drink",
    humanJob: "Actor who is also genuinely beloved on set because their energy is absolutely infectious",
    coffeeOrder: "A gorgeous ruby red hibiscus cold brew — the color is the point",
  ...
  },
  {
    ...
    personality: "The gentlest soul you'll ever meet — infinitely patient, endlessly warm, a true giant heart in a giant body",
    humanJob: "Pediatric ER nurse who has calmed every child in 20 years with impossible gentleness",
    coffeeOrder: "A massive mug of hot cocoa — warm, comforting, and entirely too large for anyone else",
  ...
  },
  {
    ...
    personality: "Warm, enormous, and completely unaware of their size — the most reliable comfort in any snowstorm",
    humanJob: "Mountain rescue specialist who has carried more people to safety than anyone else and needs no recognition",
    coffeeOrder: "A massive barrel of Swiss hot chocolate — they invented the accessory, they know how to use it",
  ...
  },
  {
    ...
    personality: "Silent, watchful, and utterly calm — the one whose very presence makes trouble decide to go somewhere else",
    humanJob: "Private investigator with an impeccable record who solves cases before anyone realizes they've started",
    coffeeOrder: "Dark roast from a thermos they've had for 15 years — consistent, no fuss, endlessly reliable",
  ...
  },
  {
    ...
    personality: "Powerful, independent, and quietly intense — the kind of personality that hunted lions and still acts unbothered",
    humanJob: "Field biologist in remote Africa who needs no backup and moves through landscapes with total confidence",
    coffeeOrder: "Bitter espresso, nothing added — earned through real hardship and no one's arguing",
  ...
  },
  {
    ...
    personality: "Ancient, inscrutable, regal — respects only those who respect them first, and has extremely good reasons",
    humanJob: "Art museum director who has an unreadable expression at every opening and everyone wants to impress",
    coffeeOrder: "They don't drink coffee — they have been here longer than coffee and will judge your choices",
  ...
  },
  {
    ...
    personality: "Elegant sprinter who goes from 35 mph to perfectly still couch potato in under 60 seconds flat",
    humanJob: "Olympic sprinter who is somehow also the most serene, mellow person in the village during the off-season",
    coffeeOrder: "A sleek cold brew — minimal, efficient, then completely at rest",
  ...
  },
  {
    ...
    personality: "The gentle giant who is always calm, always kind, and will absolutely sit on your lap if you let them",
    humanJob: "Swiss mountain dairy farmer who also does yoga and has never raised their voice in their life",
    coffeeOrder: "Warm Swiss hot chocolate by the fire — unhurried, comforting, made with real milk",
  ...
  },
  {
    ...
    personality: "Methodical, powerful, and completely dependable — doesn't make promises they won't keep",
    humanJob: "Senior detective with three commendations who solves everything through systematic observation",
    coffeeOrder: "Dark roast, exactly the same every morning — they operate on routine and it produces results",
  ...
  },
  {
    ...
    personality: "Permanently delighted by everything — a dog who aged in body but not a single day in spirit",
    humanJob: "Recess monitor and gym teacher who has never had a bad day and genuinely doesn't understand pessimism",
    coffeeOrder: "A large, frothy, sprinkled drink — it's fun, it's bright, who says adulthood has to be boring?",
  ...
  },
  {
    ...
    personality: "The deceptively clever one who is somehow playing AND working simultaneously and you didn't notice until it was done",
    humanJob: "Con artist turned fishing guide who uses a completely unique and effective method that baffles everyone",
    coffeeOrder: "Maple latte — Canadian, clever, and you didn't see it coming",
  ...
  },
  {
    ...
    personality: "Methodical, confident, and utterly loyal — does everything at their own pace and it's always exactly right",
    humanJob: "Landscape photographer who takes their time getting the shot and the result is always worth the wait",
    coffeeOrder: "Strong Scottish breakfast tea — bold, no-nonsense, steeped the right amount of time",
  ...
  },
  {
    ...
    personality: "Ancient Viking soul — bold, independent, and loyal to their people above all earthly things",
    humanJob: "Trail guide in Norway who knows every path in the mountains and has never needed GPS",
    coffeeOrder: "Boiled coffee from a cast iron pot over an open fire — ancient, strong, non-negotiable",
  ...
  },
  {
    ...
    personality: "45 mph of pure speed wrapped in a surprisingly gentle, couch-loving philosopher who naps like an art form",
    humanJob: "Retired Olympic sprinter turned meditation instructor — extreme intensity followed by profound stillness",
    coffeeOrder: "Nothing during the race; a very gentle herbal tea afterward while lying on the couch",
  ...
  },
  {
    ...
    personality: "Tough, independent, and deeply loyal — will retrieve 100 ducks from icy water and act like it was easy",
    humanJob: "Professional waterfowl guide in the Chesapeake Bay who charges accordingly and nobody questions it",
    coffeeOrder: "Black coffee from a battered thermos — they were up at 4am and don't need your sympathy",
  ...
  },
  {
    ...
    personality: "The wiser, quieter sibling of the Pembroke — ancient, loyal, and has a tail that tells its whole story",
    humanJob: "Senior librarian who has read everything, remembers everything, and gives exactly the right book recommendation",
    coffeeOrder: "Welsh Breakfast Tea, steeped precisely — they've been doing this the right way for 3,000 years",
  ...
  },
  {
    ...
    personality: "Vocal, fox-faced, and deeply independent — has opinions about everything and expresses them constantly",
    humanJob: "Radio host in a small Finnish town who everyone tunes in for and nobody can predict what they'll say next",
    coffeeOrder: "Strong Finnish filter coffee, very dark, always hot — national institution",
  ...
  },
  {
    ...
    personality: "The gentle-eyed sage who moves at their own pace, has infinite patience, and gives the best embraces",
    humanJob: "Elderly Italian chef who has mastered one dish over 50 years and teaches it freely to anyone who asks",
    coffeeOrder: "Cappuccino at exactly 10am — not 9:58, not 10:02. Italian tradition is not negotiable",
  ...
  },
  {
    ...
    personality: "Formidably intelligent and powerfully built — gives 110% to everything and expects the same from you",
    humanJob: "Elite K9 trainer who wrote the textbook, trains the trainers, and still goes out on calls",
    coffeeOrder: "Double espresso, black — the maximum before a very long and productive day",
  ...
  },
  {
    ...
    personality: "Maximum chaos potential in the smallest possible container — delightfully ridiculous at all times",
    humanJob: "Sketch comedian who also has an inexplicable talent for parkour and has broken three things this week",
    coffeeOrder: "Something they grabbed off your desk while you weren't looking — they don't even drink coffee, it's just funny",
  ...
  // Rare (20 breeds)
  {
    ...
    personality: "The terrifyingly smart overachiever who needs to be intellectually stimulated or they will restructure your house",
    humanJob: "Neuroscientist who also runs an agility school and solves crosswords in pen before breakfast",
    coffeeOrder: "Triple espresso while already executing a complex plan — they've been awake since 4am optimizing something",
  ...
  },
  {
    ...
    personality: "Gentle colossus who is completely unaware they are the biggest thing in every room they enter",
    humanJob: "Professional basketball player who also does yoga and teaches meditation retreats in the off-season",
    coffeeOrder: "An enormous cup of anything — quantity is the point, the contents are secondary",
  ...
  },
  {
    ...
    personality: "Permanently, genuinely, irresistibly happy — they have a literal smile built into their face and mean every bit of it",
    humanJob: "Kindergarten teacher who also does Arctic expeditions on sabbaticals and makes both look effortless",
    coffeeOrder: "A beautiful fluffy cloud coffee — they are the foam, they ARE the cloud",
  ...
  },
  {
    ...
    personality: "Utterly self-possessed, dramatically expressive, and bound by no rules they haven't personally approved",
    humanJob: "Influencer who does everything on their own terms, never responds to emails, and has a cult following",
    coffeeOrder: "Whatever you made but they want theirs now — on their schedule, not yours",
  ...
  },
  {
    ...
    personality: "Regal, gentle giant who brings a quiet dignity to every room and never needs to prove anything",
    humanJob: "Head of a small but distinguished foundation who writes thoughtful annual letters and mentors quietly",
    coffeeOrder: "A beautifully made flat white — civilized, warm, not rushed",
  ...
  },
  {
    ...
    personality: "The beautiful eccentric who acts aloof in public but is secretly absolutely clownish in private",
    humanJob: "Fashion model who is also inexplicably good at parkour — their agility at full speed baffles everyone",
    coffeeOrder: "They'd only consider something served in a vessel appropriate for their aesthetic — probably in a crystal glass",
  ...
  },
  {
    ...
    personality: "Ancient, contemplative, and gentle — the philosopher king who moves slowly, thinks deeply, and loves completely",
    humanJob: "Constitutional law professor who also publishes poetry and coaches a youth rugby team with infinite patience",
    coffeeOrder: "Irish breakfast tea, black — ancient tradition, enormous mug, absolute contentment",
  ...
  },
  {
    ...
    personality: "Ancient, dignified, and immovably calm — has seen 2,000 years of history and remains unrattled",
    humanJob: "Museum curator who has catalogued the entire collection from memory and moves through the halls like a force of nature",
    coffeeOrder: "A massive cup of whatever requires the least fuss — they have endured empires rising and falling",
  ...
  },
  {
    ...
    personality: "Passionately dedicated to a very specific, very valuable task — and extraordinarily charming about it",
    humanJob: "Master sommelier who can identify vintage, region, and terroir blindfolded and earns a breathtaking salary",
    coffeeOrder: "Italian espresso with exactly the right truffle chocolate — they appreciate the finest things",
  ...
  },
  {
    ...
    personality: "All the Husky intensity and drama compressed into a small package that fits in your apartment and still escapes",
    humanJob: "Start-up founder who is extremely intense, thinks about five things simultaneously, and never fully powers down",
    coffeeOrder: "A small but extremely strong espresso — miniature in size, maximum in impact",
  ...
  },
  {
    ...
    personality: "Wild, beautiful, and entirely their own creature — doesn't follow rules they haven't personally road-tested",
    humanJob: "Bayou guide who knows every waterway in Louisiana and hunts things for a living with startling efficiency",
    coffeeOrder: "Chicory coffee, Louisiana style — unique, regional, and unlike anything you've had elsewhere",
  ...
  },
  {
    ...
    personality: "Fiercely independent, impossibly loyal to their person, and operating on an internal compass that never fails",
    humanJob: "Mountain tracker in Korea who has found every person they've ever been assigned to find",
    coffeeOrder: "Korean barley tea — traditional, clean, and doesn't rely on caffeine for its effects",
  ...
  },
  {
    ...
    personality: "Fearlessly confident, musically expressive, and laser-focused once a scent hits their nose",
    humanJob: "Jazz musician and wilderness tracker — moves fast, makes beautiful noise, and always finds what they're looking for",
    coffeeOrder: "Strong percolator coffee before the 3am hunt — they're a night-shift professional",
  ...
  },
  {
    ...
    personality: "Sweet, musical, and built for the long haul — has been running beautifully and howling melodically since the Revolution",
    humanJob: "National park ranger who covers 20 miles a day, knows every trail, and sings while doing it",
    coffeeOrder: "Classic American drip coffee from a diner — historical, dependable, democratic",
  ...
  },
  {
    ...
    personality: "Elegant, ancient, and uniquely expressive — they literally glow pink with happiness and no one can resist them",
    humanJob: "Diplomat who somehow charms every room while being completely authentic — their blush is their greatest feature",
    coffeeOrder: "Herbal tea from a beautiful glass cup — ancient, warm, and radiantly amber",
  ...
  },
  {
    ...
    personality: "Clownish acrobat with the physique of a Greek statue — can jump fences from a standstill and pretend it was effortless",
    humanJob: "Parkour athlete and gymnastics coach who makes impossible movements look completely casual",
    coffeeOrder: "A strong café con leche — Spanish, warm, and completely unselfconscious",
  ...
  },
  {
    ...
    personality: "Ancient, serene, and otherworldly — exists in this world but seems to have knowledge of others",
    humanJob: "Archaeologist who has walked through Aztec ruins and feels completely at home there",
    coffeeOrder: "Warm ceremonial cacao, exactly as the ancient Mesoamericans prepared it — this is non-negotiable",
  ...
  },
  {
    ...
    personality: "Ancient, sun-warmed, and deeply attached to their person — has been a companion for 3,000 years and takes it seriously",
    humanJob: "Peruvian textile artist who works in ancient techniques and warms every room they enter",
    coffeeOrder: "Peruvian single-origin pour-over — ancient soil, extraordinary quality, hidden gem",
  ...
  },
  {
    ...
    personality: "Fierce terrier spirit in a completely unarmored package — brave without the obvious equipment to back it up",
    humanJob: "Startup founder who launched from a garage, has no ego about the circumstances, and wins every time",
    coffeeOrder: "A surprisingly hot espresso — you didn't expect it to pack that punch but here we are",
  ...
  },
  {
    ...
    personality: "Ancient, self-sufficient, and acutely aware of everything — trusts very few, but those few have a friend forever",
    humanJob: "Intelligence analyst who can assess a situation in seconds and has never once been caught off-guard",
    coffeeOrder: "Strong Turkish coffee — ancient, concentrated, and reads differently depending on who's drinking it",
  ...
  // Legendary (10 breeds)
  {
    ...
    personality: "Ancient, catlike, and operating on a completely different frequency — elegant silence conceals intense intelligence",
    humanJob: "Renowned linguist who never speaks unnecessarily and when they do, it stops the room completely",
    coffeeOrder: "A complex single-origin African pour-over that they appreciated before you even knew the country existed",
  ...
  },
  {
    ...
    personality: "The oldest aristocrat — gentle, private, deeply devoted to one person and entirely indifferent to everyone else",
    humanJob: "Desert archaeologist who has walked the Silk Road and prefers the company of ancient things to new ones",
    coffeeOrder: "Cardamom-infused Arab coffee from a traditional dallah — the original coffee culture before coffee culture existed",
  ...
  },
  {
    ...
    personality: "Ancient mountain guardian who has protected monasteries for 5,000 years and doesn't take instructions from anyone",
    humanJob: "Supreme Court justice who was already an authority on the law before they were appointed and knows it",
    coffeeOrder: "Yak butter tea — rich, ancient, and an acquired taste that rewards commitment",
  ...
  },
  {
    ...
    personality: "Sculptural, aloof, and deeply attached to their family — indifferent to everyone outside their circle, fiercely loyal within it",
    humanJob: "Rare manuscript conservator who has worked on fewer than 50 pieces in their career and each one is priceless",
    coffeeOrder: "Nomadic Tuareg tea ceremony — three glasses, each poured differently, ancient meaning in every cup",
  ...
  },
  {
    ...
    personality: "Primitive, watchful, and utterly independent — decides who matters and doesn't rethink that decision",
    humanJob: "Muay Thai instructor who has been practicing for 30 years, speaks three words at a time, and is extraordinary",
    coffeeOrder: "Thai iced coffee, strong and sweetened — ancient roots, distinctive character",
  ...
  },
  {
    ...
    personality: "Quietly extraordinary — descended from 3,000 years of volcanic island survival and still effortlessly beautiful",
    humanJob: "Archaeologist specializing in ancient Sicily who moves through lava fields as comfortably as hallways",
    coffeeOrder: "Sicilian almond granita with espresso poured over — ancient, local, extraordinary",
  ...
  },
  {
    ...
    personality: "Ancient, lively, and completely unchanged by 3,000 years of history — still hunting rabbits with original intensity",
    humanJob: "Antique dealer who has sourced items from seven centuries and never overpays for anything",
    coffeeOrder: "Bica — a tiny, intensely concentrated Portuguese espresso — small, strong, no compromise",
  ...
  },
  {
    ...
    personality: "Primal and self-reliant — survived tens of thousands of years without human help, and still notices everything",
    humanJob: "Wilderness survivalist who crossed the Appalachians on foot without a map and thinks that was a normal thing to do",
    coffeeOrder: "Whatever they can forage — truly, they've been feeding themselves for thousands of years without asking anyone",
  ...
  },
  {
    ...
    personality: "The boisterous, shaggy eccentric who is wildly enthusiastic about a very specific thing no one else cares about",
    humanJob: "Conservation biologist who specializes in the one ecosystem everyone else forgot about — and saved it",
    coffeeOrder: "Something large and messy that they knocked over by accident while getting excited about something else entirely",
  ...
  },
  {
    ...
    personality: "Remarkably versatile and quietly extraordinary — does everything well, explains nothing, asks for little",
    humanJob: "Renaissance person who herds sheep in the morning, plays violin in a string quartet in the evening, and surprises everyone constantly",
    coffeeOrder: "Hungarian unicum in a small glass — ancient, complex, and not for everyone, but perfect for those who get it",
